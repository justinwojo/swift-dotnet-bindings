...
/// in bound generic types. Public API uses Foundation.NSUrl directly.
/// </summary>
public sealed class URL : ISwiftObject, ISwiftStruct, IDisposable
{
    ...
    static ISwiftObject ISwiftObject.NewFromPayload(IntPtr handle)
    {
        ...
        unsafe
        {
            ...
            return new URL((IntPtr)heapCopy);
        }
    }
    ...
    private URL(IntPtr handle) => _payload = new SwiftSafeHandle<URL>(handle);
