...
public class TypeDatabaseExtensionsTests
{
    ...
    // Foundation Swift-overlay classes — typed Foundation.NS* remaps where the
    // counterpart exists cross-platform in the .NET ref assemblies.
    [InlineData("Foundation.ByteCountFormatter", "Foundation", "NSByteCountFormatter")]
    [InlineData("Foundation.DateComponentsFormatter", "Foundation", "NSDateComponentsFormatter")]
    [InlineData("Foundation.DateIntervalFormatter", "Foundation", "NSDateIntervalFormatter")]
    [InlineData("Foundation.EnergyFormatter", "Foundation", "NSEnergyFormatter")]
    [InlineData("Foundation.FileWrapper", "Foundation", "NSFileWrapper")]
    [InlineData("Foundation.ISO8601DateFormatter", "Foundation", "NSIso8601DateFormatter")]
    [InlineData("Foundation.LengthFormatter", "Foundation", "NSLengthFormatter")]
    [InlineData("Foundation.ListFormatter", "Foundation", "NSListFormatter")]
    [InlineData("Foundation.MassFormatter", "Foundation", "NSMassFormatter")]
    [InlineData("Foundation.MeasurementFormatter", "Foundation", "NSMeasurementFormatter")]
    [InlineData("Foundation.NetService", "Foundation", "NSNetService")]
    [InlineData("Foundation.NetServiceBrowser", "Foundation", "NSNetServiceBrowser")]
    [InlineData("Foundation.NotificationQueue", "Foundation", "NSNotificationQueue")]
    [InlineData("Foundation.PersonNameComponentsFormatter", "Foundation", "NSPersonNameComponentsFormatter")]
    [InlineData("Foundation.Pipe", "Foundation", "NSPipe")]
    [InlineData("Foundation.Port", "Foundation", "NSPort")]
    [InlineData("Foundation.PortMessage", "Foundation", "NSPortMessage")]
    [InlineData("Foundation.PropertyListSerialization", "Foundation", "NSPropertyListSerialization")]
    [InlineData("Foundation.RelativeDateTimeFormatter", "Foundation", "NSRelativeDateTimeFormatter")]
    [InlineData("Foundation.UnitConverter", "Foundation", "NSUnitConverter")]
    [InlineData("Foundation.UnitConverterLinear", "Foundation", "NSUnitConverterLinear")]
    [InlineData("Foundation.ValueTransformer", "Foundation", "NSValueTransformer")]
    // macOS-conditional types — conservative NSObject pending per-TFM XML routing.
    ...
    // Permanent NSObject — no Foundation.NS* counterpart in any ref assembly.
