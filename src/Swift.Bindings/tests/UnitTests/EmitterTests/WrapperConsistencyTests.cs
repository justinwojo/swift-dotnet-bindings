...
public class WrapperConsistencyTests
{
    ...
    /// shared = Foo() }`). Used by the wholesale-skip CanEmitMember tests so the constructed
    /// fixture matches the shape of types the parser actually emits for actor isolation.
    /// </summary>
