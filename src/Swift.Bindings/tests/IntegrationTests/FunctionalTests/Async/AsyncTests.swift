...
// Concurrency hook moved to shared library: src/Swift.Runtime/swift/SwiftBindingsRuntime.swift
// Initialize from C# via Swift.Runtime.SwiftConcurrency.Initialize()
