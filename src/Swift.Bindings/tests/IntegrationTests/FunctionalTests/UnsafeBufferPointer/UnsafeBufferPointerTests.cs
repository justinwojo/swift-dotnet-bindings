    ...
    public class UnsafeBufferPointerTests : IClassFixture<UnsafeBufferPointerTests.TestFixture>
    {
            ...
            ReadOnlySpan<byte> aad)
        {
            ...
            fixed (void* aadPtr = aad)
            {
                ...
                int result = Swift.UnsafeBufferPointerTests.UnsafeBufferPointerTests.GetAppleCryptoNative_ChaCha20Poly1305Encrypt(
                                    keyBuffer,
                                    nonceBuffer,
                                    plaintextBuffer,
                                    ciphertextBuffer,
            ...
            ReadOnlySpan<byte> aad)
        {
            ...
            fixed (void* aadPtr = aad)
            {
                ...
                int result = Swift.UnsafeBufferPointerTests.UnsafeBufferPointerTests.GetAppleCryptoNative_ChaCha20Poly1305Decrypt(
                    keyBuffer,
                    nonceBuffer,
                    ciphertextBuffer,
                    tagBuffer,
