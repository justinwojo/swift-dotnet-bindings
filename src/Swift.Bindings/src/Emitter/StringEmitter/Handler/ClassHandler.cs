...
namespace BindingsGeneration
{
    ...
    public class ClassHandler : BaseHandler, ITypeHandler
    {
        ...
        public void Emit(CSharpWriter csWriter, SwiftWriter swiftWriter, IEnvironment env, Conductor conductor, TypeHandlerContext context)
        {
...

            {
                ...
                operatorHandler.ValidateAndEmitPairs(csWriter, classDecl.Operators, typeNameWithGenerics, emittedOperatorSymbols, env.TypeDatabase, isReferenceType: true);
    ...
    class ClassISwiftObjectMethodWriter
    {
        ...
        private void WriteGetTypeMetadata()
        {
                     ...
                     WrapperValidation.IsXCFrameworkMode(_typeDatabase))
            {
                ...
                else
                {
                    ...
                    var metadataAvailability = WrapperEmitterHelpers.MergeAvailabilityFromAncestors(null, _classDecl);
        ...
        private void RecordTypeIfNonGeneric(PayloadConstructionSemantics semantics)
        {
            ...
            var typeAvailability = AvailabilityHelpers.MergeAvailabilityFromAncestors(null, _classDecl);
