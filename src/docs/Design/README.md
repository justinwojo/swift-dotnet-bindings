...
- [direct-swiftself-exposure-reporting.md](direct-swiftself-exposure-reporting.md) — Final-file DirectSwiftSelfExposure contract, completeness receipt, and copy-ready Known Limitations text
