...
| 8b — `EntityProperty.init<Entity>(…)` KeyPath-keyed convenience-init family | actionable — 8a-2 prerequisite shipped; not yet started. See `08b-…md` "Observed downstream emitter surface" for the convenience-init catalogue. | — |
