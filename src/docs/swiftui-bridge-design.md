...
**Date**: February 2026
**Status**: v1 + v2 Phase 1-2 complete; Phase 3 (Bridge Hints) next
...
## Next: v2 Phase 3 + Phase 4

See [`Future/swiftui-bridge-v2-plan.md`](Future/swiftui-bridge-v2-plan.md) for remaining work:
- **Phase 3**: Bridge Hints File — JSON sidecar for user overrides and escape hatches
...
- `src/docs/Future/swiftui-bridge-v2-plan.md` — v2 remaining phases (3-4)
