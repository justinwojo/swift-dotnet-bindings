...
extension Nuke.ImagePipeline {
    ...
    public  func PInvoke_image_27453E03(callback: @escaping @convention(c) (UIKit.UIImage, Int64) -> Void, task: Int64, _for: UnsafeRawPointer){
...
extension Nuke.ImagePipeline {
    ...
    public  func PInvoke_image_4B789A7C(callback: @escaping @convention(c) (UIKit.UIImage, Int64) -> Void, task: Int64, _for: UnsafeRawPointer){
        // Read non-frozen parameters via .pointee (bitwise copy)
        // C# created copies using InitializeWithCopy (owns a proper reference)
