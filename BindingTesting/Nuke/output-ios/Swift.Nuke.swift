...
extension Nuke.ImagePipeline {
    ...
    public  func PInvoke_image_1CD297D3(callback: @escaping @convention(c) (UIKit.UIImage, Int64) -> Void, task: Int64, _for: UnsafeRawPointer){
...
extension Nuke.ImagePipeline {
    ...
    public  func PInvoke_image_3D7E7B2E(callback: @escaping @convention(c) (UIKit.UIImage, Int64) -> Void, task: Int64, _for: UnsafeRawPointer){
        // Read non-frozen parameters via .pointee (bitwise copy)
        // C# created copies using InitializeWithCopy (owns a proper reference)
