...
extension SBW_BridgeParamTestLib_EnumParamView_Session {
    var rootView: EnumParamView { hostingController.rootView }
}

extension SBW_BridgeParamTestLib_ClassParamView_Session {
    var rootView: ClassParamView { hostingController.rootView }
    var storedModel: SimpleModel { model }
}

extension SBW_BridgeParamTestLib_TypedClosureView_Session {
    var rootView: TypedClosureView { hostingController.rootView }
}

extension SBW_BridgeParamTestLib_MultiArgClosureView_Session {
    var rootView: MultiArgClosureView { hostingController.rootView }
}

extension SBW_BridgeParamTestLib_MixedParamView_Session {
    var rootView: MixedParamView { hostingController.rootView }
}

extension SBW_BridgeParamTestLib_OptionalEnumView_Session {
    var rootView: OptionalEnumView { hostingController.rootView }
}

extension SBW_BridgeParamTestLib_OptionalClassView_Session {
...
public func SBW_TEST_EnumParamView_GetStyle(_ handle: UnsafeMutableRawPointer?) -> Int32 {
    return SBW_onMainThread {
        guard let handle = handle,
              SBW_BridgeParamTestLib_EnumParamView_liveHandles.contains(handle) else { return -1 }
        let session = Unmanaged<SBW_BridgeParamTestLib_EnumParamView_Session>
...
public func SBW_TEST_ClassParamView_GetModelValue(_ handle: UnsafeMutableRawPointer?) -> Int32 {
    return SBW_onMainThread {
        guard let handle = handle,
              SBW_BridgeParamTestLib_ClassParamView_liveHandles.contains(handle) else { return -1 }
        let session = Unmanaged<SBW_BridgeParamTestLib_ClassParamView_Session>
            .fromOpaque(handle).takeUnretainedValue()
...
/// Invoke the View's onValue closure via rootView, exercising the generated
/// wrapper conversion code (Int32 → Bool bridging).
...
public func SBW_TEST_TypedClosureView_InvokeClosure(_ handle: UnsafeMutableRawPointer?, _ value: Int32) -> Int32 {
    return SBW_onMainThread {
        guard let handle = handle,
              SBW_BridgeParamTestLib_TypedClosureView_liveHandles.contains(handle) else { return -1 }
        let session = Unmanaged<SBW_BridgeParamTestLib_TypedClosureView_Session>
            .fromOpaque(handle).takeUnretainedValue()
...
/// Invoke the View's onEvent closure via rootView, exercising the generated
/// wrapper conversion code (Int32 + Bool bridging).
...
public func SBW_TEST_MultiArgClosureView_InvokeClosure(_ handle: UnsafeMutableRawPointer?, _ val: Int32, _ flag: Int32) -> Int32 {
    return SBW_onMainThread {
        guard let handle = handle,
              SBW_BridgeParamTestLib_MultiArgClosureView_liveHandles.contains(handle) else { return -1 }
        let session = Unmanaged<SBW_BridgeParamTestLib_MultiArgClosureView_Session>
            .fromOpaque(handle).takeUnretainedValue()
...
public func SBW_TEST_MixedParamView_GetStyle(_ handle: UnsafeMutableRawPointer?) -> Int32 {
    return SBW_onMainThread {
        guard let handle = handle,
              SBW_BridgeParamTestLib_MixedParamView_liveHandles.contains(handle) else { return -1 }
        let session = Unmanaged<SBW_BridgeParamTestLib_MixedParamView_Session>
            .fromOpaque(handle).takeUnretainedValue()
        return session.rootView.style.rawValue
    }
}
...
public func SBW_TEST_OptionalEnumView_HasValue(_ handle: UnsafeMutableRawPointer?) -> Int32 {
    return SBW_onMainThread {
        guard let handle = handle,
              SBW_BridgeParamTestLib_OptionalEnumView_liveHandles.contains(handle) else { return -1 }
        let session = Unmanaged<SBW_BridgeParamTestLib_OptionalEnumView_Session>
            .fromOpaque(handle).takeUnretainedValue()
...
public func SBW_TEST_OptionalClassView_HasValue(_ handle: UnsafeMutableRawPointer?) -> Int32 {
    return SBW_onMainThread {
        guard let handle = handle,
              SBW_BridgeParamTestLib_OptionalClassView_liveHandles.contains(handle) else { return -1 }
        let session = Unmanaged<SBW_BridgeParamTestLib_OptionalClassView_Session>
            .fromOpaque(handle).takeUnretainedValue()
