...
#
# Builds the BridgeParamTestLib as an xcframework for iOS Simulator arm64.
# Produces: .build/BridgeParamTestLib.xcframework/
#
...
<dict>
    ...
    <string>BridgeParamTestLib</string>
    <key>CFBundleIdentifier</key>
    <string>com.test.BridgeParamTestLib</string>
