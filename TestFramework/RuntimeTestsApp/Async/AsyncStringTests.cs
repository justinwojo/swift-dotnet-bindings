...
public class AsyncStringTests : TestBase
{
    ...
    public async Task TestAsyncGetString()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetStringAsync(), DefaultAsyncTimeout);
    ...
    public async Task TestAsyncGetUnicodeString()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetUnicodeStringAsync(), DefaultAsyncTimeout);
    ...
    public async Task TestAsyncGetEmptyString()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetEmptyStringAsync(), DefaultAsyncTimeout);
    ...
    public async Task TestAsyncGetLongString()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetLongStringAsync(100), DefaultAsyncTimeout);
    ...
    {
        var result = await WithTimeout(AsyncStringWorker.AsyncStaticStringAsync(), DefaultAsyncTimeout);
        AssertEqual("Static async string", result, "AsyncStaticString");
        TestLogger.Info($"AsyncStringWorker.AsyncStaticStringAsync() = {result}");
    }
    ...
    public async Task TestAsyncGetStringArray()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetStringArrayAsync(), DefaultAsyncTimeout);
    ...
    public async Task TestAsyncGetEmptyArray()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetEmptyArrayAsync(), DefaultAsyncTimeout);
    ...
    public async Task TestAsyncGetSingleElementArray()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetSingleElementArrayAsync(), DefaultAsyncTimeout);
    ...
    public async Task TestAsyncGetUnicodeArray()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetUnicodeArrayAsync(), DefaultAsyncTimeout);
    ...
    public async Task TestAsyncGetIntArray()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetIntArrayAsync(5), DefaultAsyncTimeout);
    ...
    {
        var result = await WithTimeout(AsyncArrayWorker.AsyncStaticArrayAsync(), DefaultAsyncTimeout);
        ...
        TestLogger.Info($"AsyncArrayWorker.AsyncStaticArrayAsync() = [{result.Count} items]");
    }
