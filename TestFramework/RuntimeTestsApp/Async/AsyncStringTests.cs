...
public class AsyncStringTests : TestBase
{
    ...
    public async Task TestAsyncGetString()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetString(), DefaultAsyncTimeout);
    ...
    public async Task TestAsyncGetUnicodeString()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetUnicodeString(), DefaultAsyncTimeout);
    ...
    public async Task TestAsyncGetEmptyString()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetEmptyString(), DefaultAsyncTimeout);
    ...
    public async Task TestAsyncGetLongString()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetLongString(100), DefaultAsyncTimeout);
    ...
    {
        var result = await WithTimeout(AsyncStringWorker.AsyncStaticString(), DefaultAsyncTimeout);
        AssertEqual("Static async string", result, "AsyncStaticString");
        TestLogger.Info($"AsyncStringWorker.AsyncStaticString() = {result}");
    }
    ...
    public async Task TestAsyncGetStringArray()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetStringArray(), DefaultAsyncTimeout);
    ...
    public async Task TestAsyncGetEmptyArray()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetEmptyArray(), DefaultAsyncTimeout);
    ...
    public async Task TestAsyncGetSingleElementArray()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetSingleElementArray(), DefaultAsyncTimeout);
    ...
    public async Task TestAsyncGetUnicodeArray()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetUnicodeArray(), DefaultAsyncTimeout);
    ...
    public async Task TestAsyncGetIntArray()
    {
        ...
        var result = await WithTimeout(worker.AsyncGetIntArray(5), DefaultAsyncTimeout);
    ...
    {
        var result = await WithTimeout(AsyncArrayWorker.AsyncStaticArray(), DefaultAsyncTimeout);
        ...
        TestLogger.Info($"AsyncArrayWorker.AsyncStaticArray() = [{result.Count} items]");
    }
