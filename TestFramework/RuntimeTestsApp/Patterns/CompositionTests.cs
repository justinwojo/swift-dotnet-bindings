...
public class BasicCompositionTests : TestBase
{
    ...
    public void TestValueAnimalHasValueConformance()
    {
        ...
        AssertTrue(va is ISwiftHasValue, "ValueAnimal should implement ISwiftHasValue");
        TestLogger.Info("ValueAnimal conforms to ISwiftHasValue");
    }
    ...
    public void TestBatchConfigTagCountNil()
    {
        ...
        AssertEqual(0, config.TagCount(), "TagCount should be 0 for nil tags");
        TestLogger.Info($"BatchConfig nil tags: TagCount = {config.TagCount()}");
    }
    ...
    public void TestBatchConfigTagCountWithTags()
    {
        ...
        AssertEqual(3, config.TagCount(), "TagCount should be 3");
        TestLogger.Info($"BatchConfig with tags: TagCount = {config.TagCount()}");
    }
    ...
    public void TestValueAnimalHasValueInterface()
    {
        ...
        ISwiftHasValue hasVal = va;
        AssertEqual(55, hasVal.Value, "ISwiftHasValue.Value should be 55");
        hasVal.Value = 77;
        AssertEqual(77, hasVal.Value, "ISwiftHasValue.Value after set should be 77");
        TestLogger.Info($"ISwiftHasValue interface dispatch: {hasVal.Value}");
    }
    ...
    public void TestRegistryRegisterAndCount()
    {
        ...
        AssertEqual(1, registry.Count(), "Count should be 1 after register");
        TestLogger.Info($"Registry: registered id={id}, count={registry.Count()}");
    }
    ...
    public void TestRegistryClear()
    {
        ...
        AssertEqual(1, registry.Count(), "Count should be 1");
        registry.Clear();
        AssertEqual(0, registry.Count(), "Count should be 0 after clear");
