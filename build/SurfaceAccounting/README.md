...
- old/tip capture receipts, including source/toolchain/input identities, command exits, and one stage
...
The Nuke target re-expands the manifest with `ValidationManifest.ExpandTargets`, requires the fixed
