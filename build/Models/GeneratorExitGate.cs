...
/// regeneration.
///
/// <para><b>The defect this closes.</b> The macOS / Mac Catalyst regeneration path logged a non-zero
/// generator exit as a warning — "this is expected if the test library includes features beyond
/// current generator support" — and then went on to build the app against bindings that were never
/// emitted. A generator that exits 1 having written zero C# does not produce a degraded run; it
