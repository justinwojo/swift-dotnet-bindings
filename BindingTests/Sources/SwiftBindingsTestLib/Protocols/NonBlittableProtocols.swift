...
/// NOTE: Renamed from describeAll to avoid collision with Existentials.swift
/// which has a similar function taking [any Describable]. Both would marshal
/// to the same C# signature.
public func describeAllNamed(_ items: [any Named]) -> [String] {
