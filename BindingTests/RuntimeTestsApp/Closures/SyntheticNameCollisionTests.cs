...
/// <summary>
/// End-to-end coverage for the MethodClosureBridge synthetic-name guard. The @_cdecl
...
public class SyntheticNameCollisionTests : TestBase
{
    ...
    public void TestSelfParamCollision_RoundTrips()
    {
        ...
        TestLogger.Info("self_ collision round-trip passed");
    }
    ...
    public void TestSelfObjParamCollision_RoundTrips()
    {
        ...
        TestLogger.Info("selfObj collision round-trip passed");
    }
    ...
    public void TestCdeclParamCollision_RoundTrips()
    {
        ...
        TestLogger.Info("cdecl collision round-trip passed");
    }
    ...
    public void TestBoxParamCollision_RoundTrips()
    {
        ...
        TestLogger.Info("_box_0 collision round-trip passed");
    }
    ...
    public void TestAdapterParamCollision_RoundTrips()
    {
        ...
        TestLogger.Info("__adapter0 collision round-trip passed");
    }
}
