...
/// <c>Transform(RefBox)</c>, so the overload group is disambiguated by a numeric suffix in
/// DECLARATION order: the first-declared non-optional overload keeps <c>Transform</c> (+100) and the
/// optional overload takes <c>Transform2</c> (+200).
///
