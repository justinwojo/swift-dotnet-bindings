...
/// </summary>
// Mirror the facade's platform contract (LiveActivity is [SupportedOSPlatform("ios16.2")] +
// [UnsupportedOSPlatform("maccatalyst")]) onto the consumer so CA1416 is satisfied at the call
// sites — the runtime IsSupportedOS / EnsureReadyToRequestAsync guards below remain the actual
// runtime safety net, and the test-discovery invoker that constructs/calls this type is
// `// <auto-generated/>`, so these attributes don't cascade into it.
